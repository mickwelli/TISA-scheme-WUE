#' deSetembro_df
#' 
#' @description ET, T, E, and GPP data for the 25 de Setembro irrigation scheme.
#' 
#' @format A data frame comprising 63270 rows and 37 columns. 
#' \describe{
#'    \item{x}{Longitude}
#'    \item{y}{Latitude}
...
#'    \item{LUE_var}{Variance of Light Use Efficiency prediction}
...
#'    \item{GPP_var}{Variance of GPP prediction}
